...
function OplataSpanishPage() {
  ...
  const courseImage = '/media/оплата курса по испанскому.png';
  ...
  useEffect(() => {
    ...
    // Если язык не испанский, но мы на странице испанского - перенаправляем
    if (savedLanguage && savedLanguage !== 'spanish') {
  ...
  const handleBuyClick = async (e) => {
    ...
    if (isValid) {
      try {
        ...
        // Создаем платеж
        const language = localStorage.getItem('courseLanguage') || 'spanish';
...
export default OplataSpanishPage;