...
function ItalianPaymentPage() {
  ...
  const handlePayClick = async () => {
    ...
    if (isValid) {
      ...
      localStorage.setItem('courseLanguage', 'italian');
      ...
      <main className="payment-main">
        <section className="payment-order">
          ...
          <div className="payment-order__course-block">
            <img 
              src="/media/оплата курса по итальянскому.png" 
              alt="Italian Course" 
...
export default ItalianPaymentPage;