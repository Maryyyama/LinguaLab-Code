...
function OplataJapanesePage() {
  ...
  const courseImage = '/media/оплата курса по японскому.png';
  ...
  useEffect(() => {
    ...
    if (savedLanguage && savedLanguage !== 'japanese') {
  ...
  const handleBuyClick = async (e) => {
    ...
    if (isValid) {
      try {
        ...
        const language = localStorage.getItem('courseLanguage') || 'japanese';
...
export default OplataJapanesePage;