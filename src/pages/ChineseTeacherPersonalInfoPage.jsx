...
function ChineseTeacherPersonalInfoPage() {
  ...
  const [teacherData, setTeacherData] = useState({
    name: 'Ван Сяо',
    avatar: '/media/ван сяо личная инф.png',
    specialization: 'Китайский язык (носитель языка), деловой китайский',
    experience: '12 лет',
    education: ['Пекинский университет иностранных языков (магистр китайской филологии)', 'Сертификат HSK (уровень 10)'],
    methodology: 'Коммуникативный подход, изучение через погружение в китайскую культуру',
    groups: [
      'Группа начинающих (HSK 1-2)',
      'Деловой китайский (HSK 5-6)'
    ],
    individualStudents: 8,
  ...
  useEffect(() => {
    ...
    if (user.role === 'teacher') {
      ...
      if (teacherLogin !== 'wang_xiao' && teacherLogin !== 'Ван Сяо') {
        ...
        } else if (teacherLogin === 'juan_perez' || teacherLogin === 'Хуан Пере') {
...
export default ChineseTeacherPersonalInfoPage;