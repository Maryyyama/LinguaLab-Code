...
function JapanesePaymentPage() {
  ...
  const handlePayClick = async () => {
    ...
    if (isValid) {
      ...
      localStorage.setItem('courseLanguage', 'japanese');
      ...
      <main className="payment-main">
        <section className="payment-order">
          ...
          <div className="payment-order__course-block">
            <img 
              src="/media/оплата курса по японскому.png" 
              alt="Japanese Course" 
...
export default JapanesePaymentPage;