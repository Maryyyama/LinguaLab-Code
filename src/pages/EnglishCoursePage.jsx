...
function EnglishCoursePage() {
  ...
  const reviews = [
    ...
    { author: 'Дмитрий В.', role: 'Студент', text: 'Начал изучать английский с нуля. Курс помог освоить базу быстро и эффективно. Рекомендую всем новичкам!', stars: 5 }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('currentCourseId', 'english-beginner');
      ...
      <main>
        ...
        <section className="course-main container">
          <div className="course-main__info">
            <h1 className="black-text">Английский для начинающих</h1>
            <h2 className="black-text">О курсе</h2>
            <span className="course-main__after">После прохождения курса</span>
            <ul>
              <li className="black-text">Вы сможете представиться на английском языке</li>
              <li className="black-text">Научитесь вести простые диалоги на бытовые темы</li>
              <li className="black-text">Освоите базовую грамматику английского языка</li>
