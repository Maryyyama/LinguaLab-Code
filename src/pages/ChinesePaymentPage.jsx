...
function ChinesePaymentPage() {
  ...
  const handlePayClick = async () => {
    ...
    if (isValid) {
      // Берем данные из localStorage, которые сохранились на странице курса
      ...
      localStorage.setItem('currentCourseId', savedCourseId || '69bd725c71dff7d18ddeec73');
      localStorage.setItem('courseLevel', savedLevel || 'beginner');
      navigate('/oplata-chinese');
    }
    setLoading(false);
  };
      ...
      <main className="payment-main">
        <section className="payment-order">
          ...
          <div className="payment-order__course-block">
            <img 
              src="/media/оплата курса по китайскому.png" 
              alt="Chinese Course" 
...
export default ChinesePaymentPage;