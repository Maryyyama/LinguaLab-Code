...
function OplataEnglishPage() {
  ...
  const courseImage = '/media/оплата курса по английскому.png';
  ...
  useEffect(() => {
    ...
    // Если язык не английский, но мы на странице английского - перенаправляем
  ...
  const handleBuyClick = async (e) => {
    ...
    if (isValid) {
      try {
        ...
        // Создаем платеж
        const language = localStorage.getItem('courseLanguage') || 'english';
...
export default OplataEnglishPage;