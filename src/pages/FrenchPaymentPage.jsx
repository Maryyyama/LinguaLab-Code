...
function FrenchPaymentPage() {
  ...
  const handlePayClick = async () => {
    ...
    if (isValid) {
      ...
      localStorage.setItem('courseLanguage', 'french');
      ...
      <main className="payment-main">
        <section className="payment-order">
          ...
          <div className="payment-order__course-block">
            <img 
              src="/media/оплата курса по французскому.png" 
              alt="French Course" 
...
export default FrenchPaymentPage;