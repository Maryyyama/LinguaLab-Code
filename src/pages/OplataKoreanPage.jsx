...
function OplataKoreanPage() {
  ...
  const courseImage = '/media/оплата курса по корейскому.png';
  ...
  useEffect(() => {
    ...
    if (savedLanguage && savedLanguage !== 'korean') {
  ...
  const handleBuyClick = async (e) => {
    ...
    if (isValid) {
      try {
        ...
        const language = localStorage.getItem('courseLanguage') || 'korean';
...
export default OplataKoreanPage;